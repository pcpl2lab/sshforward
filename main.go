...
import "github.com/pcpl2lab/sshforward/cmd"
...
//
//go:generate go run github.com/tc-hib/go-winres@v0.3.3 make --arch 386,amd64,arm64 --file-version 0.0.0.0 --product-version 0.0.0.0
